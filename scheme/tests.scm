...
(define (potato x y) (eval '(cons x y)))
(potato 'hi (define x 3))
; expect (hi . x)

'(potato 'hi (define x 3))
; expect (potato (quote hi) (define x 3))

(define (f) e) (define (e) d) (define (d) c) (define (c) b) (define (b) a) (define (a) 1) 
((((((f))))))
; expect 1

(begin (define x (lambda (y z) (+ 45 y z))) (display '(cons 1 2)) (x 6 8))
; expect (cons 1 2)59

(and (define x 3) 34 #t 'potato)
; expect potato

(define x 'potato)
(cond ((or (and (and 6 3) (and (display 20) #f)) #t)(let ((x 37)) ((lambda (x) (- x 19)) x))))
; expect 2018
...
(define f (mu () (+ p q)))
(define (g) (define p 5) (define q 12) (f))
(g)
; expect 17
; END PROBLEM 0
